...
'''
Script distribute_costs.py

A python script to distribute costs from direct general_ledger accounts to clinical events.
    ...
    REQUIRED
    hospital_code
    The hospital code for the hospital whose clinical costs are being calculated
    by distributing costs to clinical events.

    model_code
    The model code for the clinical costing model that is being used
    to calculate clinical costs by distributing costs to clinical events.
    ...
    Then distribute the costs data to clinical events.
'''
