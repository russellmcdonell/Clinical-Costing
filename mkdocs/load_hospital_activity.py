...
'''
Script load_hospital_activity.py

A python script to load the patient activity data for a hospital
into the Clinical Costing tables, from an Excel workbook.
    ...
    one sheet for the model code/name and one sheet for each extract
    of hospital Patient Activity matching tables in the Clinical Costing database.
