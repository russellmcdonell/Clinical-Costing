...
'''
Script load_hospital.py

A python script to load the configuration data for a hospital
into the Clinical Costing tables, from an Excel workbook.
    ...
    -I inputDir|--inputDir=inputDir
    The directory where the the Excel workbook containing
    the hospital configuration data to be loaded can be found.
    ...
    And each sheet should have a header row with headings that match
...
if __name__ == '__main__':
    ...
    The main code
    Start by parsing the command line arguements and setting up logging.
    Then connect to the database and check the Excel workbook - it should have one sheet for the hospital code/name
    and one sheet for each hospital configuration table, in the Clinical Costing database.
