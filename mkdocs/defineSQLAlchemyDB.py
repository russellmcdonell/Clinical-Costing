...
'''
Script defineSQLAlchemyDB.py

A Python script containing the SQLAchemy definitions of the Clinical Costing database tables
'''
...
class feeder_model(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['hospital_code'], ['hospitals.hospital_code']),
        ForeignKeyConstraint(['hospital_code', 'model_code'], ['models.hospital_code', 'models.model_code']),
