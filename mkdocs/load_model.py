...
A python script to load the clinical costing model configuration data, for a specific costing model
...
<br/>
    ...
    OPTIONS
    -C configDir|--configDir=configDir
    The directory where the database connection configuration file
    can be found (default='databaseConfig')
    ...
    -I inputDir|--inputDir=inputDir
    The directory where the Excel workbook containing
    the clinical costing model configuration data to be loaded can be found.

    -i inputWorkbook|--inputWorkbook=inputWorkbook
    The Excel workbook containing the clinical costing model configuration data
    to be loaded for this hospital.
    ...
    one sheet for the model code/name and one sheet for each model configuration table,
    in the Clinical Costing database.
    Each sheet should have a header row with headings that match
    the names of the columns in the associated database table.
'''
...
if __name__ == '__main__':
    ...
    parser.add_argument('-I', '--inputDir', dest='inputDir', default='.',
                        help='The directory containing the Excel workbook containing the clinical costing model to be loaded.')
    parser.add_argument('-i', '--inputWorkbook', dest='inputWorkbook',
                        default='.', help='The Excel workbook containing the clinical costing model configuration data to be loaded for this hospital.')
