...
'''
The load_hospital_costs script loads the hospital costs data for a hospital
into the Clinical Costing tables, from an Excel workbook.

NOTE: The hospital activity must be loaded before the hospital costs, as itemized costs refer to episodes of activity.
